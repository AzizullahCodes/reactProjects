...
const OrderSuccess = () => {
    ...
    // checkout page se state me orderId aur total aata hai
    // agar direct URL se aaya ho (state na ho) to dummy data use kar lo
    const { orderId = "482913", total = 1500 } = location.state || {};
